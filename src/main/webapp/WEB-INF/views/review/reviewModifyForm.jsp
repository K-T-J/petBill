...
<c:if test="${sessionScope.userId eq 'admin'}"><!-- 관리자 리뷰삭제 -->
 <body>
   ...
   <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
        	<!-- 로고 -->
            <div class="sidebar-heading border-bottom bg-light"><a href="/petBill/user/main.pet"><img src="/petBill/resources/imgs/로고화면.png" style="width: 170px; margin-top: 10px;"></a></div>
            <div class="list-group list-group-flush">
